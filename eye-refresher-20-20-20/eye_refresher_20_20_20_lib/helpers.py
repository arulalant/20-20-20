...
from . eye_refresher_20_20_20config import get_data_file
...
def get_builder(builder_file_name):
    ...
    builder = Builder()
    builder.set_translation_domain('eye-refresher-20-20-20')
...
def set_up_logging(opts):
    ...
    lib_logger = logging.getLogger('eye_refresher_20_20_20_lib')
...
def get_help_uri(page=None):
    ...
    if not os.path.exists(help_uri):
        ...
        help_uri = 'eye-refresher-20-20-20'
